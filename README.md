...
除主题关键词检索外，系统还会通过 ISSN 对 Nature Electronics、Nature Communications、Nature Biomedical Engineering、npj Flexible Electronics、Microsystems & Nanoengineering、Science Advances、Science Robotics、Cell Reports Physical Science、Matter、Device 等 15 个目标子刊执行期刊专属检索。目标子刊中明确涉及柔性触觉、电子皮肤、压力/力传感或触觉交互的论文会进入观察队列，PushPlus 优先推送其中与研究画像最相关的 5 篇。

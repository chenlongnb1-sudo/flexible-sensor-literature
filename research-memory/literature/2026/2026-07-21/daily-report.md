...
| openalex | - | `tactile sensor analog front-end in-sensor computing` | 14 | ok |
...
| crossref | npj Flexible Electronics | `flexible tactile electronic skin wearable pressure haptic neuromorphic sensor` | 0 | failed |
...
- crossref：1 个查询失败；首个错误为 HTTPError: HTTP Error 429: Too Many Requests。其余来源已继续运行。

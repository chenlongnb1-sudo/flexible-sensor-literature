...
- 历史重复排除：92 篇
- 期刊等级排除：70 篇
- 小类分布：电子皮肤与触觉 2 篇；神经形态与传感计算 6 篇；软体机器人与人机交互 7 篇；可穿戴健康与生理监测 10 篇；制造、封装与可靠性 3 篇；多模态与生化传感 2 篇
...
### 3. [Convergence of Soft Electronics and Artificial Intelligence: From Materials to Intelligent Systems](https://doi.org/10.1007/s40820-026-02265-x)
...
### 4. [Flexible Dual-Modal Sensing Transistor Enabled by Deep Learning Decoupling for Independent Light and Temperature Reconstruction](https://doi.org/10.1007/s40820-026-02285-7)
...
### 5. [MXene–Ag 2 Se@sponge Dual‐Modal Sensor for Decoupled Temperature and Pressure Sensing](https://doi.org/10.1002/adfm.77025)

- 来源：Advanced Functional Materials；2026-07-10；分类：可穿戴健康与生理监测；评分 47/100
- 为什么重要：提供机器人、可穿戴或电子皮肤系统任务证据；可用于低离散/装配容差触觉界面的结构与对照设计
- 摘要级结论：提供机器人、可穿戴或电子皮肤系统任务证据；可用于低离散/装配容差触觉界面的结构与对照设计。摘要可核实数值包括：2.202 kPa、25 kPa、0.466 kPa、60 kPa、0.076 kPa。
- 方法：Here, we present a flexible dual‐modal sensor constructed from a sponge framework decorated with MXene–Ag 2 Se nanocomposite.
- 摘要数值：2.202 kPa、25 kPa、0.466 kPa、60 kPa、0.076 kPa、300 kPa、37 ms
- 可迁移：提供机器人、可穿戴或电子皮肤系统任务证据；可用于低离散/装配容差触觉界面的结构与对照设计；把论文的跨模态解耦机制迁移为法向/切向通道设计，并分别验证结构解耦、模拟前端解耦和软件解耦的增益。
...
| 软体机器人与人机交互 | 53 | [Pneumatic Comparator With Multiple Sensitivities for Electronics‐Free Soft Robots](https://doi.org/10.1002/adfm.77172) | skim |
...
| 神经形态与传感计算 | 47 | [Ion‐Specific Network Reconfiguration in Gelatin Hydrogels Enables Self‐Powered Photodetection and Neuromorphic Perception](https://doi.org/10.1002/smll.74464) | skim |
| 可穿戴健康与生理监测 | 46 | [An Asymmetric Glassy Wrinkled Hydrogel for Integrated Antifouling Protection and Robust Adhesion](https://doi.org/10.1002/adfm.77019) | skim |
| 可穿戴健康与生理监测 | 46 | [Nonionic Coacervate‐Derived Gel with Programmable Stiffness and State‐Adaptive Healing Capability](https://doi.org/10.1002/adfm.76870) | skim |
...
| Ultra‐Tough and Stable Leather‐Derived Gel Wearable Sensor: Enabling Multimodal Monitoring of Human Motion Signals and Distress Signal Transmission | ABSTRACT In extreme scenarios such as emergency rescue operations, conventional hydrogel sensors face significant challenges in achieving real‐time distress signal transmission due to their mechanical brittleness and str | 70%、13.5 MPa、590.0%、78.0%、550 nm | 提供机器人、可穿戴或电子皮肤系统任务证据 |
| Flexible Ag 2 Se‐Based Thermoelectrics: Fundamentals, Processing, and Device Applications | Additionally, the challenges of device stability, large‐area integration, and multifunctional system design are assessed. | 摘要未给出 | 提供机器人、可穿戴或电子皮肤系统任务证据；可用于低离散/装配容差触觉界面的结构与对照设计 |
| Dynamic and Sustainable Polyurethane Elastomers for Wearable Electronics: From Green Synthesis to Self‐Healing and Circularity | This review systematically summarizes the design principles of dynamic and sustainable PUEs and their development trajectories in wearable electronics. | 摘要未给出 | 涉及坏点、漂移、跨器件迁移或少样本校准；提供机器人、可穿戴或电子皮肤系统任务证据 |
| Strategy of Triple‐Gradient in Binary Pixels for Flexible Pressure Sensing with High Sensitivity and Wide‐Range Linearity | Herein, a flexible pressure sensor based on design of binary micro‐dome pixels is proposed. | 974.1 kPa、1.8 MPa | 提供机器人、可穿戴或电子皮肤系统任务证据；涉及坏点、漂移、跨器件迁移或少样本校准 |
| Knittable electronic textiles for intelligent soft wearables | Knitting’s interlooped, three-dimensional architectures and computationally-enabled design allow the fabrication of customized electronic textiles that conform to the body while supporting integrated sensing, actuation,  | 摘要未给出 | 提供机器人、可穿戴或电子皮肤系统任务证据 |
| Pressure‐Induced Drift Artifacts in Stretchable Liquid Metal ThinFilm Electrocardiogram Electrodes | We developed a stretchable LM thin‐film electrode integrated with an LM strain sensor to quantitatively investigate the drift artifact alongside skin deformation simultaneously and in situ. | 摘要未给出 | 可用于低离散/装配容差触觉界面的结构与对照设计；涉及坏点、漂移、跨器件迁移或少样本校准 |
| Engineering Layered Magnetic Hydrogels for Cell Placement via Shear and Magnetic Field‐Induced Assembly | ABSTRACT The design of hydrogel‐based artificial tissues capable of reversible, programmed, and complex motions requires both stimuli‐responsiveness and structural anisotropy. | 95% | 可用于低离散/装配容差触觉界面的结构与对照设计；涉及 in-sensor/物理计算或可编程触觉前端 |
| Self‐Powered MXene@Perovskite Thermoelectric Skin for Multimodal Mid‐Infrared Sensing and Human Signal Recognition | Here, we developed a bio‐inspired, self‐powered thermoelectric skin based on a V 2 C MXene@CsPbBr 3 heterostructure. | 14 µm、95.9% | 提供机器人、可穿戴或电子皮肤系统任务证据 |
...
### Idea 3：把论文机制映射为 3x3 可编程物理触觉投影核

- 对应轨道：P4；分级：B
- 来源论文：Anti‐Freezing Fiber‐Shaped Iontronic Synapses With Ultralow Energy Consumption and High Rectification
...
| 来源 | 目标期刊 | 查询 | 命中 | 状态 |
|---|---|---|---:|---|
| arxiv | - | `electronic skin fault tolerant transferable calibration domain adaptation` | 3 | ok |
| crossref | - | `electronic skin fault tolerant transferable calibration domain adaptation` | 25 | ok |
| openalex | - | `electronic skin fault tolerant transferable calibration domain adaptation` | 2 | ok |
| semantic_scholar | - | `electronic skin fault tolerant transferable calibration domain adaptation` | 0 | failed |
| arxiv | - | `electronic skin tactile array compressed readout low channel` | 3 | ok |
...
| openalex | - | `tactile sensor neuromorphic encoding in-sensor computing robotic perception` | 20 | ok |
...
| openalex | - | `tactile sensor analog front-end in-sensor computing` | 13 | ok |
...
| openalex | - | `flexible tactile sensor assembly tolerance response dispersion electrode microstructure` | 5 | ok |
...
| openalex | - | `flexible tactile sensor vector shear friction slip direction` | 3 | ok |
| semantic_scholar | - | `flexible tactile sensor vector shear friction slip direction` | 0 | ok |
| crossref | ACS Nano | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 176 | ok |
| crossref | Advanced Electronic Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 34 | ok |
| crossref | Advanced Energy Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 124 | ok |
| crossref | Advanced Fiber Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 10 | ok |
| crossref | Advanced Functional Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 615 | ok |
| crossref | Advanced Healthcare Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 105 | ok |
| crossref | Advanced Intelligent Systems | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 24 | ok |
| crossref | Advanced Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 470 | ok |
| crossref | Advanced Materials Technologies | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 70 | ok |
| crossref | Advanced Optical Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 113 | ok |
| crossref | Advanced Science | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 458 | ok |
...
| crossref | Communications Chemistry | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 42 | ok |
| crossref | Communications Engineering | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 23 | ok |
| crossref | Communications Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 59 | ok |
| crossref | Communications Physics | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 43 | ok |
| crossref | Device | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 31 | ok |
| crossref | InfoMat | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 14 | ok |
| crossref | International Journal of Extreme Manufacturing | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 23 | ok |
| crossref | Joule | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 48 | ok |
| crossref | Light: Science & Applications | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 42 | ok |
...
| crossref | Nano Energy | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 68 | ok |
| crossref | Nano Letters | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 154 | ok |
| crossref | Nano-Micro Letters | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 37 | ok |
| crossref | National Science Review | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 60 | ok |
| crossref | Nature | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 292 | ok |
| crossref | Nature Biomedical Engineering | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 30 | ok |
...
| crossref | Nature Electronics | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 12 | ok |
| crossref | Nature Machine Intelligence | `tactile electronic skin neuromorphic sensor computing robotic perception` | 16 | ok |
| crossref | Nature Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 39 | ok |
...
| crossref | Nature Sensors | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 18 | ok |
| crossref | npj Flexible Electronics | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 14 | ok |
| crossref | Proceedings of the National Academy of Sciences | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 422 | ok |
| crossref | Research | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 26 | ok |
| crossref | Science | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 179 | ok |
| crossref | Science Advances | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 317 | ok |
| crossref | Science Robotics | `tactile electronic skin flexible sensor haptic robotic perception` | 6 | ok |
| crossref | Science Translational Medicine | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 31 | ok |
| crossref | Small | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 437 | ok |
| crossref | Small Methods | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 78 | ok |

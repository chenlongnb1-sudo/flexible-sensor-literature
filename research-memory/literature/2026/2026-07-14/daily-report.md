...
- 来源：Microsystems & Nanoengineering；2026-06-15；评分 63/100
...
| openalex | `electronic skin fault tolerant transferable calibration domain adaptation` | 0 | failed |
...
| openalex | `electronic skin tactile array compressed readout low channel` | 0 | failed |
...
| openalex | `near-sensor analog computing tactile sensing electronic skin` | 0 | failed |
...
| openalex | `tactile sensor neuromorphic encoding in-sensor computing robotic perception` | 0 | failed |
...
| openalex | `tactile sensor physical computing analog computing programmable projection` | 0 | failed |
...
| openalex | `tactile sensor analog front-end in-sensor computing` | 0 | failed |
...
| openalex | `flexible tactile sensor assembly tolerance response dispersion electrode microstructure` | 0 | failed |
...
| openalex | `flexible tactile sensor vector shear friction slip direction` | 0 | failed |
...
- openalex：8 个查询失败；首个错误为 HTTPError: HTTP Error 429: Too Many Requests。其余来源已继续运行。

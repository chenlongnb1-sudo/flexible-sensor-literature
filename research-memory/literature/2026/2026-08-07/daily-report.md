# 2026-08-07 柔性电子高水平文献日报

## 今日结论

本次从 OpenAlex、Crossref、Semantic Scholar、arXiv 和 Science 官网 RSS 检索最近 3 天结果，去重并排除历史已收录论文后保留 7 篇。
...
- 历史重复排除：25 篇
- 期刊等级排除：10 篇
- 小类分布：可穿戴健康与生理监测 2 篇；电子皮肤与触觉 2 篇；制造、封装与可靠性 2 篇；软体机器人与人机交互 1 篇
...
| 分类 | 评分 | 论文 | 建议 |
|---|---:|---|---|
| 可穿戴健康与生理监测 | 52 | [Large Language Model‐Driven Throat‐Wearable Sensing System for Real‐Time Recognition and Evaluation of Swallowing Disorders](https://doi.org/10.1002/adhm.71548) | skim |
| 电子皮肤与触觉 | 51 | [Biomimetic Gradient Microstructures Enable Stable, High‐Sensitivity Pressure Sensing From Pa to MPa](https://doi.org/10.1002/adfm.77497) | skim |
| 可穿戴健康与生理监测 | 43 | [Circuit‐Free Cardiovascular Monitoring via Smartphone‐Readable Skin‐Interfaced Nanophotonic Films](https://doi.org/10.1002/adma.74512) | skim |
| 电子皮肤与触觉 | 40 | [Sealing the Leak: Sensor‐Aided Vaginal Pessaries for Stress Incontinence Treatment](https://doi.org/10.1002/admt.71232) | skim |
| 制造、封装与可靠性 | 39 | [Surface and Interfacial Engineering toward Durable Mechanically Coupled Flexible Electronics](https://doi.org/10.1002/advs.76797) | skim |
| 软体机器人与人机交互 | 37 | [Cooperative and Ordered Cross‐Scale Assembly of Carbon Nanotube Fibers](https://doi.org/10.1002/adma.74400) | skim |
| 制造、封装与可靠性 | 29 | [Breaking the “Impossible Trinity” in Flexible Phase‐Change Materials with Dynamic Adaptable Encapsulation](https://doi.org/10.1002/adfm.77537) | skim |

## 方法与指标速览

| 论文 | 方法（摘要证据） | 可核实数值 | 画像价值 |
|---|---|---|---|
| Large Language Model‐Driven Throat‐Wearable Sensing System for Real‐Time Recognition and Evaluation of Swallowing Disorders | S3‐LLM converts them into structured signal sequences and combines temporal encoding with parameter‐efficient fine‐tuning, thereby exploiting the representation and generalization capabilities of LLMs under few‐shot cond | 92.4%、87.6%、20% | 涉及 in-sensor/物理计算或可编程触觉前端；涉及坏点、漂移、跨器件迁移或少样本校准 |
| Biomimetic Gradient Microstructures Enable Stable, High‐Sensitivity Pressure Sensing From Pa to MPa | Here, we present a geometry‐guided strategy for stable pressure sensing from Pa to MPa based on a biomimetic daisy‐inspired gradient hemispherical array. | 122 kPa、2555 kPa、1864 kPa、61 kPa、7.6 Pa、5 ms | 可用于低离散/装配容差触觉界面的结构与对照设计；提供机器人、可穿戴或电子皮肤系统任务证据 |
| Circuit‐Free Cardiovascular Monitoring via Smartphone‐Readable Skin‐Interfaced Nanophotonic Films | ABSTRACT Nanoscale mechano‐optical surfaces enable electronics‐free strain sensing, attractive for skin‐interfaced devices, yet reported implementations require laser/spectrometer interrogation, negating this advantage. | 2%、9%、65% | 提供机器人、可穿戴或电子皮肤系统任务证据 |
| Sealing the Leak: Sensor‐Aided Vaginal Pessaries for Stress Incontinence Treatment | Here, we present a smart, personalized vaginal pessary manufactured by extrusion‐based 3D‐printing with integrated flexible piezoelectric pressure sensors to enable real‐time intravaginal force measurements. | 100%、10 mm | 涉及坏点、漂移、跨器件迁移或少样本校准 |
| Surface and Interfacial Engineering toward Durable Mechanically Coupled Flexible Electronics | To address these challenges, various material systems designed to enhance surface and interfacial performance are systematically reviewed, focusing on surface chemical modification, interfacial chemical engineering, as w | 摘要未给出 | 可用于低离散/装配容差触觉界面的结构与对照设计；涉及坏点、漂移、跨器件迁移或少样本校准 |
| Cooperative and Ordered Cross‐Scale Assembly of Carbon Nanotube Fibers | Conventional research has often focused on adjusting isolated process parameters and preparation strategies based on equilibrium‐state assumptions, lacking a systematic grasp of non‐equilibrium growth kinetics and the sy | 摘要未给出 | 可用于低离散/装配容差触觉界面的结构与对照设计；提供机器人、可穿戴或电子皮肤系统任务证据 |
| Breaking the “Impossible Trinity” in Flexible Phase‐Change Materials with Dynamic Adaptable Encapsulation | A double‐network skeleton of cellulose nanofibers (CNF) and aramid nanofibers (ANF), cross‐linked by reversible Fe 3+ ‑tannic acid (TA) coordination, is designed to create an adaptive matrix. | 175%、3.50 W、94.59%、30 dB | 与柔性触觉相关，但尚未显示对前端触觉计算的直接贡献 |
...
| crossref | ACS Nano | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 23 | ok |
| crossref | Advanced Electronic Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 4 | ok |
| crossref | Advanced Energy Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 16 | ok |
| crossref | Advanced Fiber Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 2 | ok |
| crossref | Advanced Functional Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 59 | ok |
| crossref | Advanced Healthcare Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 17 | ok |
...
| crossref | Advanced Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 76 | ok |
| crossref | Advanced Materials Technologies | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 14 | ok |
| crossref | Advanced Optical Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 13 | ok |
| crossref | Advanced Science | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 63 | ok |
...
| crossref | Communications Materials | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 3 | ok |
| crossref | Communications Physics | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 9 | ok |
...
| crossref | Light: Science & Applications | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 6 | ok |
...
| crossref | Microsystems & Nanoengineering | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 2 | ok |
...
| crossref | Nano Letters | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 17 | ok |
...
| crossref | Nature | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 59 | ok |
...
| crossref | Nature Communications | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 132 | ok |
...
| crossref | Proceedings of the National Academy of Sciences | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 47 | ok |
...
| crossref | Science | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 36 | ok |
| crossref | Science Advances | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 43 | ok |
...
| crossref | Small | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 84 | ok |
| crossref | Small Methods | `flexible tactile electronic skin wearable pressure force strain haptic neuromorphic sensor array readout robotic perception` | 11 | ok |
